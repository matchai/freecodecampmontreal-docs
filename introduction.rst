Introduction
================
Don't know what freecodecamp is? Find out here_.
...
.. _here: https://www.freecodecamp.org/
...
As the discord (hopefully) grows, more docs will be added on a need-to-know basis and you can refer to these docs whenever. Even though it will touch a few features (mentors, coding session schedules, etc.) which are only available to the freecodecamp-montreal discord, the goal is to have resources that anyone can use.
